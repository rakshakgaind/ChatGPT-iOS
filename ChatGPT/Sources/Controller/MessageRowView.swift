...
struct MessageRowView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            //MARK: User Input Text
            messageRow(text: message.sendText, image: message.sendImage, bgColor: colorScheme == .dark ? .gray : Color(red: 236, green: 236, blue: 241, opacity: 1))
        
            // MARK: AI Response Message text
